...
export const defaultSettingsMeta = {
    ...
    out_of_hours_handoff_message: {
        ...
        defaultValue: `يا هلا بيك يا فندم! 🌙\nسجلت بياناتك واستفسارك مع فريق المبيعات وهيكونوا معاك أول بأول 📋\n\nمواعيد العمل عندنا يومياً من 10:00 صباحاً لحد 11:00 مساءً (ويوم الجمعة إجازة)، وهيتواصلوا مع حضرتك تليفونياً أو على الواتساب مع بداية الشفت الصبح علطول ✨\n\nولحد ما يكلموك، أنا المساعد الآلي ومعاك 24 ساعة.. لو حابب تسأل عن أي تفاصيل في المتجر أو محتاج مساعدة قولي وأنا معاك خطوة بخطوة! 🚀`
    },
